...
class DoctorTest < HybridSearch::TestCase
  def test_reports_postgres_and_pgvector_ok
    checks = HybridSearch::Doctor.new.call
  ...
  def test_model_checks_report_missing_embeddings
    ...
    checks = HybridSearch::Doctor.new(Product).call
  ...
  def test_unconfigured_model_reports_error
    ...
    checks = HybridSearch::Doctor.new(klass).call
