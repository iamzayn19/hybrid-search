...
require_relative "lib/hybrid_search/version"

Gem::Specification.new do |spec|
  spec.name = "hybrid_search"
  spec.version = HybridSearch::VERSION
  ...
  spec.description = "HybridSearch gives Rails applications hybrid keyword and semantic search " \
  ...
  spec.homepage = "https://github.com/iamzayn19/hybrid-search"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.3.0"

  spec.metadata["allowed_push_host"] = "https://rubygems.org"
  spec.metadata["changelog_uri"] = "https://github.com/iamzayn19/hybrid-search/blob/main/CHANGELOG.md"
  spec.metadata["bug_tracker_uri"] = "https://github.com/iamzayn19/hybrid-search/issues"
